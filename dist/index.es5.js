...
var script = defineComponent({
  setup: function setup() {
    var _inject = inject(PLUGIN_NAME),
        ...
        isCreatedTeleport = _inject.isCreatedTeleport;
...
var script$1 = defineComponent({
  ...
  setup: function setup(props) {
    ...
    function closeKeyEvent(event) {
      var isLastChild = document.querySelector("#".concat(teleportComponentId, " .").concat(CLASS_NAME, ":last-child")) === modal.value;
    ...
    return {
      ...
      teleportComponentId: teleportComponentId,
      isCreatedTeleport: isCreatedTeleport,
      modal: modal,
      state: state,
      emitClose: emitClose,
      setClose: setClose,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.isCreatedTeleport ? (openBlock(), createBlock(Teleport, {
    key: 0,
    to: "#".concat(_ctx.teleportComponentId),
    ...
    default: withCtx(function () {
      ...
      /* CLASS, STYLE, PROPS */
      , ["id", "aria-label", "aria-labelledby"]), [[vShow, _ctx.state.show]])];
    }),
    _: 3
  }, 8
  /* PROPS */
