...
var script = defineComponent({
    setup() {
        const { teleportComponentId, isCreatedTeleport } = inject(PLUGIN_NAME);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", { id: _ctx.teleportComponentId }, null, 8 /* PROPS */, ["id"]))
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.isCreatedTeleport)
    ? (openBlock(), createBlock(Teleport, {
        key: 0,
        to: `#${_ctx.teleportComponentId}`,
